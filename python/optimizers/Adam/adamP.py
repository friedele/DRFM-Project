...
class ADAM_P(optimizer_v2.OptimizerV2):
    ...
    def __init__(self,
        ...
        super(ADAM_P, self).__init__(name, **kwargs)
    ...
    def _prepare_local(self, var_device, var_dtype, apply_state):
        super(ADAM_P, self)._prepare_local(var_device, var_dtype, apply_state)
    ...
    def set_weights(self, weights):
        ...
        super(ADAM_P, self).set_weights(weights)
    ...
    def get_config(self):
        config = super(ADAM_P, self).get_config()
        config.update({
